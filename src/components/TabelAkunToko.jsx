                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {data.map((akun_toko,idx)=>(
                            ...
                            <td className="px-6 py-4">
                                <button onClick={() => edit(akun_toko)} className="mr-2 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</button>
                                <button onClick={() => deletetoko(akun_toko.idToko)} className="ml-2 font-medium text-blue-600 dark:text-blue-500 hover:underline">Hapus</button>
                            </td>
                        </tr>
                        ))}
                    </tbody>
