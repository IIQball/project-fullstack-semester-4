    ...
    return(
        <>
            <div className="fixed w-full">
                <nav className="bg-slate-100 border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-900 h-24 ">
                    <div className="container flex flex-wrap items-center justify-between mx-auto">
                        <a className="flex items-center">
                            <span className="self-center text-2xl font-semibold whitespace-nowrap p-6 text-black">{props.title}</span>
                            </a>
